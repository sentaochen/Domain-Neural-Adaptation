...
This repository contains a paper with supplementary material for the deep domain adaptation approach DNA. A pytorch implementation of the DNA approach will also be included a few months later (due the concerns with some on-going related works).  
